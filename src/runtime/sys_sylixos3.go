...
//go:nosplit
//go:cgo_unsafe_args
func syscall_syscallXnull(fn, a1, a2, a3 uintptr) (r1, r2, err uintptr) {
	entersyscall()
	libcCall(unsafe.Pointer(abi.FuncPCABI0(syscallXnull)), unsafe.Pointer(&fn))
	exitsyscall()
	return
}
func syscallXnull(fn, a1, a2, a3 uintptr) (r1, r2, err uintptr)

//go:linkname syscall_syscallXerrno syscall.syscallXerrno
//go:nosplit
//go:cgo_unsafe_args
func syscall_syscallXerrno(fn, a1, a2, a3 uintptr) (r1, r2, err uintptr) {
	entersyscall()
	libcCall(unsafe.Pointer(abi.FuncPCABI0(syscallXerrno)), unsafe.Pointer(&fn))
	exitsyscall()
	return
}
func syscallXerrno(fn, a1, a2, a3 uintptr) (r1, r2, err uintptr)
...
//go:nosplit
//go:cgo_unsafe_args
func syscall_syscall6Xerrno(fn, a1, a2, a3, a4, a5, a6 uintptr) (r1, r2, err uintptr) {
	entersyscall()
	libcCall(unsafe.Pointer(abi.FuncPCABI0(syscall6Xerrno)), unsafe.Pointer(&fn))
	exitsyscall()
	return
}
func syscall6Xerrno(fn, a1, a2, a3, a4, a5, a6 uintptr) (r1, r2, err uintptr)
...
func syscall10X(fn, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10 uintptr) (r1, r2, err uintptr)
...
func rawSyscall6X(fn, a1, a2, a3, a4, a5, a6 uintptr) (r1, r2, err uintptr)
...
func rawSyscall10X(fn, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10 uintptr) (r1, r2, err uintptr)
